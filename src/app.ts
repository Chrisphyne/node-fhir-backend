...
import maintenanceRecordRouter from './routes/v1/maintenanceRecord';
import inventoryItemRouter from './routes/v1/inventoryItem';
import inventoryTransactionRouter from './routes/v1/inventoryTransaction';
import appointmentRouter from './routes/v1/appointment';
import encounterRouter from './routes/v1/encounter';
import medicationRouter from './routes/v1/medication';
import medicationRequestRouter from './routes/v1/medicationRequest';
import serviceRequestRouter from './routes/v1/serviceRequest';
import diagnosticReportRouter from './routes/v1/diagnosticReport';
import observationRouter from './routes/v1/observation';
import referralRouter from './routes/v1/referral';
import invoiceRouter from './routes/v1/invoice';
...
// routes
  ...
  app.use('/api/v1/maintenanceRecord', maintenanceRecordRouter);
  app.use('/api/v1/inventoryItem', inventoryItemRouter);
  app.use('/api/v1/inventoryTransaction', inventoryTransactionRouter);
  app.use('/api/v1/appointment', appointmentRouter);
  app.use('/api/v1/encounter', encounterRouter);
  app.use('/api/v1/medication', medicationRouter);
  app.use('/api/v1/medicationRequest', medicationRequestRouter);
  app.use('/api/v1/serviceRequest', serviceRequestRouter);
  app.use('/api/v1/diagnosticReport', diagnosticReportRouter);
  app.use('/api/v1/observation', observationRouter);
